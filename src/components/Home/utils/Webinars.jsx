...
const Webinars = () => {
  ...
  return (
    <Container maxWidth="lg" className="py-12 bg-background">
      <Box className="mb-8">
        <section className="pt-[3.2rem] pb-[4.2rem] flex flex-col gap-y-[1.2rem]">
          <Typography variant="h2" className="font-extrabold text-blue-500 text-center mb-4">
            Our Webinars
          </Typography>
          <Typography variant="h6" className="text-center mb-6 text-muted-foreground">
                          Online webinar are waiting for you
